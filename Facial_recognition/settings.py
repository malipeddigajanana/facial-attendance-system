...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "attendance/templates"],  # App-specific templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / 'attendance/static',  # Static files in your app folder
]

# Media files (uploaded files)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # Folder to store uploaded media files

# Default auto field
DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'

# Email settings (optional, for notifications, etc.)
